        ...
        <nav className={` border-gray-200 ${props.isDarkMode ? 'dark bg-gray-900' : 'bg-gray-50'}`}>
            <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white"><img
                    src={props.isDarkMode ? props.logo : props.logo2}
                    alt="brand"
                ...
                <div className="flex items-center md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
                    ...
                    <button
                        ...
                        className={`relative inline-flex items-center text-lg font-medium text-center ${props.isDarkMode ? 'text-white' : 'text-gray-500'} hover:text-gray-900 focus:outline-none ${props.isDarkMode ? 'dark:hover:text-white' : 'dark:text-gray-400'} mx-6 pe-5`}
                        type="button"
                    >
                        <svg
                            className={`w-6 h-6 ${props.isDarkMode ? 'text-white' : 'text-gray-500'}`} // Change color based on dark mode
                            aria-hidden="true"
                        ...
                        <div className={`absolute block w-3 h-3 bg-red-500 border-2 border-white rounded-full -top-0.5 start-2.5 ${props.isDarkMode ? 'dark:border-gray-900' : 'border-white'}`}></div>
                    </button>
                    ...
                    <button id="dropdownAvatarNameButton" data-dropdown-toggle="dropdownAvatarName" className=" ms-5 flex items-center text-sm pe-1 font-medium text-gray-900 rounded-full hover:text-blue-600 dark:hover:text-blue-500 md:me-0 focus:ring-0 focus:outline-none dark:text-white" type="button">
                        ...
                        <img className="w-8 h-8 me-2 rounded-full" src={UserContext?.user?.image ?? "https://images.unsplash.com/photo-1633332755192-727a05c4013d?ixlib=rb-1.2.1&amp;ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&amp;auto=format&amp;fit=crop&amp;w=1480&amp;q=80"} alt="user photo" />
